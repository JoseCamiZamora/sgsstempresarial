...
use App\Http\Controllers\TrainingReinforcementController;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => ['role:Super Admin|Administrador SGSST']], function () {
        ...
        Route::prefix('capacitaciones')->name('training.')->group(function(){
            ...
            Route::get('/inducciones',[TrainingInductionController::class,'index'])->middleware('permission:capacitaciones.sesiones.ver')->name('inductions.index');
            Route::post('/inducciones',[TrainingInductionController::class,'store'])->middleware('permission:capacitaciones.sesiones.crear')->name('inductions.store');
            ...
            Route::get('/refuerzos',[TrainingReinforcementController::class,'index'])->middleware('permission:capacitaciones.refuerzos.ver')->name('reinforcements.index');
            Route::post('/refuerzos/{reinforcement}/programar',[TrainingReinforcementController::class,'schedule'])->middleware('permission:capacitaciones.refuerzos.gestionar')->name('reinforcements.schedule');
            Route::get('/analitica',[\App\Http\Controllers\TrainingAnalyticsController::class,'index'])->middleware('permission:capacitaciones.indicadores.ver')->name('analytics.index');
            Route::get('/matriz',[\App\Http\Controllers\TrainingMatrixController::class,'index'])->middleware('permission:capacitaciones.matriz.ver')->name('matrix.index');
            Route::get('/matriz/exportar',[\App\Http\Controllers\TrainingMatrixController::class,'export'])->middleware('permission:capacitaciones.matriz.exportar')->name('matrix.export');
            Route::get('/brechas',[\App\Http\Controllers\TrainingGapController::class,'index'])->middleware('permission:capacitaciones.brechas.ver')->name('gaps.index');
            Route::post('/brechas/necesidad',[\App\Http\Controllers\TrainingGapController::class,'createNeed'])->middleware('permission:capacitaciones.brechas.gestionar')->name('gaps.need');
            Route::get('/brechas/exportar',[\App\Http\Controllers\TrainingGapController::class,'export'])->middleware('permission:capacitaciones.matriz.exportar')->name('gaps.export');
            Route::get('/alertas',[\App\Http\Controllers\TrainingAlertController::class,'index'])->middleware('permission:capacitaciones.alertas.ver')->name('alerts.index');
            Route::post('/alertas/analizar',[\App\Http\Controllers\TrainingAlertController::class,'scan'])->middleware('permission:capacitaciones.alertas.gestionar')->name('alerts.scan');
            Route::patch('/alertas/{a}',[\App\Http\Controllers\TrainingAlertController::class,'update'])->middleware('permission:capacitaciones.alertas.gestionar')->name('alerts.update');
            Route::get('/integraciones/estandares',[\App\Http\Controllers\TrainingStandardsIntegrationController::class,'index'])->middleware('permission:capacitaciones.integraciones.estandares.ver')->name('standards.index');
            Route::get('/informes/gestion.pdf',[\App\Http\Controllers\TrainingReportController::class,'pdf'])->middleware('permission:capacitaciones.informes.generar')->name('reports.pdf');
            Route::get('/informes/indicadores.xlsx',[\App\Http\Controllers\TrainingReportController::class,'excel'])->middleware('permission:capacitaciones.informes.generar')->name('reports.excel');
        });
