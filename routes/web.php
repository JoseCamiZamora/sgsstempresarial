...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('transporte')->name('transport.')->group(function () {
        ...
        Route::put('/configuracion/checklists/{template}', [TransportSettingController::class, 'updateChecklist'])->middleware('permission:transporte.configuracion.gestionar')->name('settings.checklists.update');
        Route::delete('/configuracion/checklists/{template}', [TransportSettingController::class, 'deactivateChecklist'])->middleware('permission:transporte.configuracion.gestionar')->name('settings.checklists.deactivate');
        Route::put('/configuracion/checklists/{template}/activar', [TransportSettingController::class, 'activateChecklist'])->middleware('permission:transporte.configuracion.gestionar')->name('settings.checklists.activate');
        ...
        Route::put('/vehiculos/{vehicle}/activar', [TransportVehicleController::class, 'activate'])->middleware('permission:transporte.vehiculos.gestionar')->name('vehiculos.activate');
        ...
        Route::put('/personal/{person}/activar', [TransportPersonController::class, 'activate'])->middleware('permission:transporte.conductores.gestionar')->name('personal.activate');
        ...
        Route::put('/rutas/{transportRoute}/activar', [TransportRouteController::class, 'activate'])->middleware('permission:transporte.rutas.gestionar')->name('rutas.activate');
        ...
        Route::put('/pasajeros/{passenger}/activar', [TransportPassengerController::class, 'activate'])->middleware('permission:transporte.pasajeros.gestionar')->name('pasajeros.activate');
        Route::get('/pasajeros-carga-masiva/plantilla', [TransportPassengerController::class, 'importTemplate'])->middleware('permission:transporte.pasajeros.gestionar')->name('pasajeros.import.template');
        Route::post('/pasajeros-carga-masiva', [TransportPassengerController::class, 'importMasivo'])->middleware('permission:transporte.pasajeros.gestionar')->name('pasajeros.import.store');
        Route::get('/pasajeros-carga-masiva/resultado', [TransportPassengerController::class, 'importResultado'])->middleware('permission:transporte.pasajeros.gestionar')->name('pasajeros.import.resultado');
        ...
        Route::get('/reportes/gestion/{type}.pdf', [TransportReportController::class, 'management'])->middleware('permission:transporte.reportes.generar')->name('reports.management');
        Route::get('/reportes/novedades.pdf', [TransportReportController::class, 'issues'])->middleware('permission:transporte.reportes.generar')->name('reports.issues');
        Route::get('/reportes/documentos.pdf', [TransportReportController::class, 'documents'])->middleware('permission:transporte.reportes.generar')->name('reports.documents');
        Route::get('/reportes/indicadores.xlsx', [TransportReportController::class, 'indicatorsExcel'])->middleware('permission:transporte.reportes.exportar')->name('reports.indicators.excel');
        Route::get('/reportes/historico.xlsx', [TransportReportController::class, 'historyExcel'])->middleware('permission:transporte.reportes.exportar')->name('reports.history.excel');
        ...
        Route::get('/reportes/programacion.pdf', [TransportReportController::class, 'programmingPdf'])->middleware('permission:transporte.reportes.programacion')->name('reports.programming.pdf');
        Route::get('/reportes/programacion.xlsx', [TransportReportController::class, 'programmingExcel'])->middleware('permission:transporte.reportes.programacion')->name('reports.programming.excel');
        Route::get('/reportes/operacion.xlsx', [TransportReportController::class, 'operationExcel'])->middleware('permission:transporte.reportes.operacion')->name('reports.operation.excel');
        Route::get('/reportes/llegadas-semanales.pdf', [TransportReportController::class, 'operationWeekly'])->middleware('permission:transporte.reportes.operacion')->name('reports.operation.weekly');
        Route::get('/servicios/{s}/informe.pdf', [TransportReportController::class, 'operationService'])->middleware('permission:transporte.reportes.operacion')->name('reports.operation.service');
    });
    Route::resource('incidentes', IncidenteController::class)->middleware('permission:reportar_incidentes');
    ...
    Route::group(['middleware' => ['role:Super Admin|Administrador SGSST']], function () {
        ...
        Route::get('empleados-carga-masiva/exportar', [EmpleadoController::class, 'exportImportResult'])->name('empleados.import.export');
        Route::post('empleados-carga-masiva/notificar', [EmpleadoController::class, 'notifyImportResult'])->name('empleados.import.notify');
